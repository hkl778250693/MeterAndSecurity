...
import com.example.administrator.thinker_soft.adapter.TaskFileDeleteListAdapter;
...
public class TaskFileDeleteActivity extends Activity {
    ...
    private void defaultSetting() {
        MySqliteHelper helper = new MySqliteHelper(TaskFileDeleteActivity.this, 1);
    ...
    private void clearData() {
        helper = new MySqliteHelper(TaskFileDeleteActivity.this, 1);
        db = helper.getWritableDatabase();
