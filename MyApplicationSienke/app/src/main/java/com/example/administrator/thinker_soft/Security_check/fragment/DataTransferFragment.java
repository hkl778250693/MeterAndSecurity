                        ...
                        if (stringList.size() > 1) {
                            ...
                            new Thread() {
                                ...
                                public void run() {
                                    ...
                                    requireMyTask("SafeCheckPlan.do", "securityId=" + securityIds.substring(0,securityIds.length()-1) + "&startTime=" + startDateTv.getText().toString() + "&endTime=" + endDateTv.getText().toString());
                                    super.run();
                                }
                            }.start();
