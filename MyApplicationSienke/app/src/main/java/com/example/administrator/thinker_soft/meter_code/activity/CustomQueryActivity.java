 ...
 */
public class CustomQueryActivity extends Activity {
    ...
    private void defaultSetting() {
        ...
        sharedPreferences = CustomQueryActivity.this.getSharedPreferences(sharedPreferences_login.getString("login_name", "") + "data", Context.MODE_PRIVATE);
    }
