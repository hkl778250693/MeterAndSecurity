...
public class MeterAllUserListActivity extends Activity {
    ...
    private void defaultSetting() {
        MySqliteHelper helper = new MySqliteHelper(MeterAllUserListActivity.this, 1);
        db = helper.getWritableDatabase();
        sharedPreferences_login = this.getSharedPreferences("login_info", Context.MODE_PRIVATE);
        sharedPreferences = MeterAllUserListActivity.this.getSharedPreferences(sharedPreferences_login.getString("login_name", "") + "data", Context.MODE_PRIVATE);
        /**
